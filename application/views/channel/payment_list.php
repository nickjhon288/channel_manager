...
<?php  if(user_type()=='1' || user_type()=='2' && in_array('4',user_edit()) || admin_id()!='' && admin_type()=='1'){ ?>
  ...
  <a href="#payment" class="cls_com_blubtn pull-right waves-effect waves-light m-r-5 m-b-10" data-animation="sidefall" data-plugin="custommodal" data-overlaySpeed="50" data-overlayColor="#000"> <i class="fa fa-plus-circle"></i>Add payment Method </a>
...
<td>
<!--  <a href="javascript:;" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#cash" > Cash </a> -->

 <a href="#cash" class="waves-effect waves-light m-r-5 m-b-10" data-animation="sidefall" data-plugin="custommodal" data-overlaySpeed="50" data-overlayColor="#000">Cash </a> 

 <!-- <li class="display_none">
      <a href="#edit_tax" class="btn waves-effect waves-light m-r-5 m-b-10 edit_tax" data-animation="sidefall" data-plugin="custommodal" data-overlaySpeed="50" data-overlayColor="#000"></a>
</li> -->
...
<tr>
<td> <button type="submit" class="btn <?php if($pay_method_status=='1'){ ?> btn-success <?php } else { ?> btn-danger <?php } ?> btn-sm"> <?php if($pay_method_status=='1'){echo 'yes';}else{echo 'No';} ?> </button> 
</td>
...
<div id="payment" class="modal-demo modal-dialog modal_list modal-content">
  <button type="button" class="close login_close" onclick="Custombox.close();">
  <span>&times;</span><span class="sr-only">Close</span>
  </button>
  <h4 class="custom-modal-title">
  <?php echo get_data(CONFIG)->row()->company_name;?> Add Payment method</h4>
  <hr>
...
<div id="cash" class="modal-demo modal-dialog modal_list modal-content">
  <button type="button" class="close login_close" onclick="Custombox.close();">
  <span>&times;</span><span class="sr-only">Close</span>
  </button>
  <h4 class="custom-modal-title">
