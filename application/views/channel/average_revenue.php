          ...
          <?php } ?>
              ...
              <div class="col-sm-6 col-xs-12 cls_dateblk">
                <div class="clearfix">
                 ...
                 <input type="text" id="average_from_date" name="from_date" class="form-control" placeholder="From">
                    <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                  <div id="datetimepicker2" class="input-group date cls_resdate">
                    <input type="text" id="average_to_date" class="form-control" placeholder="To">
                    <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                </div>
              </div>
