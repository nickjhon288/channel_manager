...
<div class="col-md-11 col-sm-11 col-xs-12 cls_cmpilrigh">
  ...
  <h4><a href="<?php echo lang_url(); ?>reservation/payment_list">My Property</a>
    <i class="fa fa-angle-right"></i>Payment</h4>
  </div>  
  <hr>
<div class="box-m">
<div class="row">
...
<?php $error = $this->session->flashdata('error'); 
 ...
 -->
      <a href="#addbank_account" class="btn btn-info waves-effect waves-light m-r-5 m-b-10" data-animation="sidefall" data-plugin="custommodal" data-overlaySpeed="50" data-overlayColor="#000">
 <i class="fa fa-plus-circle"></i> Add Bank account </a>
...
<tr>
  ...
  <td> <a href="javascript:;" onclick="return edit_bank_details('<?php echo $bank->bank_id; ?>');"> <?php echo $bank->bank_name; ?> 
     </a>
      <li class="display_none">
      <a href="#editbank_account" class="btn waves-effect waves-light m-r-5 m-b-10 edit_bankdet" data-animation="sidefall" data-plugin="custommodal" data-overlaySpeed="50" data-overlayColor="#000"></a>
      </li>
  </td>
...
<div class="modal fade" id="payment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <div id="addbank_account" class="modal-demo modal-dialog modal_list modal-content">
...
<div id="editbank_account" class="modal-demo modal-dialog modal_list modal-content">
  ...
  <div class="custom-modal-text">
   <form class="form-horizontal" method="post" id="edit_bank_detailsss" action="<?php echo lang_url(); ?>reservation/edit_bankdetailss">   
    <div class="reg_content" id="edit_results">
    </div>
    </form>
  </div>
</div>
