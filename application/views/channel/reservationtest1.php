...
// echo $uri;die;
$room = $this->reservation_model->select_reserve($uri);
...
<p><i class="fa fa-print"></i> <a href="<?php echo lang_url(); ?>reservation/reservation_print/<?php echo insep_encode($room->reservation_id); ?>"> Print</a> </p>
