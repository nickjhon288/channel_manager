...
<div class="col-sm-6 col-xs-12 cls_select_in">
                <div class="clearfix">
                  <div class="select-style1">
                   <select value="selected" id="report_reseravtion" class="form-control" onchange="return report_reservation();">
					<?php 
                  ...
                  <div class="select-style1">
                   <select value="selected" id="channel_reservation" class="form-control" onchange="return report_reservation();">
              ...
              <div class="col-sm-6 col-xs-12 cls_dateblk">
                <div class="clearfix">
                  ...
                  <input type="text" id="reservation_from_date" name="from_date" class="form-control" placeholder="From" value="<?php echo $from_date; ?>">                  
                    <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                  <div id="datetimepicker2" class="input-group date cls_resdate">
                   <input type="text" id="reservation_to_date" class="form-control" placeholder="To" value="<?php echo $to_date; ?>">
                    <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                </div>
              </div>
...
<div class="box-m">
	...
	<div class="chart-container">
		...
		<input type="hidden" value="Reservation" id="show_text" name="show_text" />					
