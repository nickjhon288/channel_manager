...
<?php if($channel_status=='1' && ($channel_id==2 && ( $ch->xml_type == 2 || $ch->xml_type == 3 )) || ($channel_id!=2 & $channel_id!=39))  {  ?>
...
<div class="row mar-top20" align="center">
<?php if($channel_status=='1' && ($channel_id==2 && ( $ch->xml_type == 2 || $ch->xml_type == 1 )) || ($channel_id!=2 && $channel_id!=39) ) {
...
<div class="room_form  col-md-8">
  ...
  <div class="form-group border-channel">
    ...
    <label class="radio-inline">
		<input type="radio" value="enabled" <?php if(isset($ch->status)){ if($ch->status=='enabled'){ echo 'checked="checked"';} }else {echo 'checked="checked"';} ?>  id="inlineRadio2" name="optionenable"> Enabled
	</label>
	<label class="radio-inline">
  ...
  <?php if($channel_id != 15 && $channel_id != 2 && $channel_id != 1 && $channel_id !=39){ ?>
  <div class="form-group border-channel">
  ...
  <div class="form-group border-channel">
    ...
    <?php } elseif($channel_id ==39) { ?>
  
 <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3"> <?php if($channel_id ==39) {echo "Secrect";}?> Api Key  <i class="fa fa-exclamation-circle"></i></label>
    <div class="col-sm-4 mar-top7">
      <input type="password" value="<?php if(isset($ch->user_password)){echo $ch->user_password;} ?>" name="user_password" placeholder="" id="ch_user_password" class="form-control">
      </div>
      <span class="errors mar-top7">*</span><i>Required</i>
  ...
  <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3">Username <i class="fa fa-exclamation-circle"></i></label>
    <div class="col-sm-4 mar-top7">
      <input type="text" value="<?php echo $channel_username; ?>" name="user_name" placeholder="" id="ch_user_name" class="form-control" readonly> <!--readonly-->
  </div>
      <span class="errors mar-top7">*</span><i>Required</i>
    <div class="col-sm-5">
      <label for="exampleInputName2"></label>
  ...
  <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3">Password  <i class="fa fa-exclamation-circle"></i></label>
    <div class="col-sm-4 mar-top7">
      <input type="password" value="<?php echo $channel_password; ?>" name="user_password" placeholder="" id="ch_user_password" class="form-control" readonly> <!--readonly-->
      </div>
      <span class="errors mar-top7">*</span><i>Required</i>
  ...
  <?php if((($channel_id == 14 && isset($ch->hotel_channel_id)!='') || $channel_id!='14' ) && $channel_id != '39' )
{
  ?>
  <div class="form-group border-channel">
  ...
  <?php if($channel_id == 8 ){ ?>
  <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3"><?php echo "WEB ID";?>  <i class="fa fa-exclamation-circle"></i></label>
		<div class="col-sm-4 mar-top7">
