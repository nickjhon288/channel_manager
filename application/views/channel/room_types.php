...
<div id="add_extra" class="modal-demo modal-dialog modal_list modal-content">
    ...
    <div class="custom-modal-text">
        <form action="<?php echo lang_url();?>inventory/extras/add" id="add_extra_form" method="POST">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="service">Price<span class="errors">*</span></label>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="service">Taxes %<span class="errors">*</span></label>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="service">Price Structure<span class="errors">*</span></label>
            ...
            <input type="submit" id="add_extra_submit" class="cls_com_blubtn hover-shadow pull-right" value="Submit" />  
        </form>
    </div>
</div>
