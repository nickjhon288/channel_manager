               ...
               <div class="login-bg" >
                ...
                <?php $site_logo = get_data(CONFIG,array('id'=>1))->row()->site_logo; ?>
                    ...
                    <div class="login-content">
                      <center>  <img aling= center src= "data:image/png;base64,<?php echo base64_encode(file_get_contents("uploads/logo/".$site_logo));?>" class="login-logo" title="Go to website" > 	</center>
		...
		<div class="row bs-reset">
			...
			<div class="col-xs-8 bs-reset">
				<div class="login-copyright text-right">
					<p>Hoteratus - Hospitality Sotware Solutions  Signup/Login</p>
				</div>
			</div>
		</div>
	</div>
...
<script src="<?php echo base_url(); ?>user_assets/js/jquery.sl
scroll.min.js" type="text/javascript"></script>
