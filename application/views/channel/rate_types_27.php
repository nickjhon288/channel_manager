<div class="modal-content" id="success_msg">
      <div class="modal-header">
        ...
        <h4 class="modal-title pad-b text-uppercase text-center" id="myModalLabel">Edit rate type</h4>
      </div>
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <?php 
            ...
            { 
                extract($meal);
        ?>
          <option value="<?php echo $meal_id;?>" <?php if($meal_plan==$meal_id) { ?> <?php } ?>><?php echo $meal_name;?></option>
          <?php } ?>
        </select>
        </div>
