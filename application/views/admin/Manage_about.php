<?php $this->load->view('admin/header');?>
  ...
  <div class="manage">
    ...
    <?php     
          ...
          <?php }?> 
       <?php 
          if($action== "add") $title ="Add About Us" ;
          else if($action== "edit") $title ="Edit About Us" ;
          else if($action== "view_single" || $action== "view") $title ="View About Us";
        ?>
      <div class="col-md-12">
...
<?php if($action== "view"){?>
      ...
      cellspacing="0">
			...
			<tbody>
                ...
                <td><?php echo substr($row->content,121); ?> </td>
                <?php
                echo "<td>";
                
        $value=array('class'=>'edit');
        echo anchor('admin/about/edit/'.$row->id,'<i class="fa fa-pencil" title="edit"></i>',$value).'&nbsp;  ';
    ...
    <?php if($action== "edit"){?>
     <div class="row">
                ...
                <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout1');
                                  echo form_open_multipart('admin/about/update/'.$id,$attributes); ?>
                  <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout1');
                                  echo form_open_multipart('admin/about/update/'.$id,$attributes); ?>
