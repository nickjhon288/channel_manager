<?php $this->load->view('admin/header');?>
  ...
  <i class="fa fa-home"></i> Privacy and Policy
  </div>
  </div>
  ...
  <div class="manage">
    ...
    <?php     
          ...
          <?php }?> 
       <?php 
          if($action== "add") $title ="Add Privacy and Policy" ;
          else if($action== "edit") $title ="Edit Privacy and Policy" ;
          else if($action== "view_single" || $action== "view") $title ="View Privacy and Policy";
        ?>
      <div class="col-md-12">
...
<?php if($action== "view"){?>
      ...
      cellspacing="0">
        ...
        echo anchor('admin/privacy/edit/'.$row->id,'<i class="fa fa-pencil" title="edit"></i>',$value).'&nbsp;';
 ...
 <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-lg-6">
                    <?php echo form_open_multipart('admin/privacy/update/'.$id); ?>
          <span class="error"><?php echo validation_errors();?></span>
              ...
              <!--input type="hidden" name="id" value="<?php echo $id;?>"/>-->
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="privacy_content" required name="content"  ><?php if(isset($content)){
              echo $content; }
              ?></textarea>
        ...
        <div class="row">
          <div class="col-lg-12"><div class="col-lg-1"></div>
            ...
            <span class="error"><?php echo validation_errors();?></span>
                 ...
                 <button type="submit" name="add_service" class="btn btn-success" value="Add Services">Add Privacy and Policy</button>
