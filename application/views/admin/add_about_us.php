                                ...
                                <div class="col-lg-6">
									...
									<span class="error"></span>
                                        ...
                                        <div class="form-group">
											...
											<div class="form-group">
                                            <label><font color="#CC0000">*</font>About Image</label>
                                            <inputname="image" type="file" value="" onChange="showimagepreview(this)" />   <span class="error">
										 ...
										 <button type="submit" name="add_service" class="btn btn-success" value="ADD SERVICEs">ADD ABOUTs</button>
