...
?> 
                        <div class="panel panel-default">
                            <div class="panel-heading"><a href="<?php echo base_url(); ?>index.php/admin/add_admin/"><button type="button" style="width: 157px; height: 33px; margin-top: -8px; float:left;" class="pull-right label label-success">Add New <i class="fa fa-plus"></i></button></a>
