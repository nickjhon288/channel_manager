<?php $this->load->view('admin/header');?>
  ...
  <i class="fa fa-home"></i> Connected Channels
  </div>
  </div>
  ...
  <div class="manage">
    ...
    <?php     
          ...
          <?php }?> 
       <?php 
          if($action== "add") $title ="Add Connected Channels" ;
          else if($action== "edit") $title ="Edit Connected Channels" ;
          else if($action== "view_single" || $action== "view") $title ="View Connected Channels";
        ?>
      <div class="col-md-12">
...
<?php if($action== "view"){?>
      ...
      cellspacing="0">
        ...
        echo anchor('admin/connectchannels/edit/'.$row->id,'<i class="fa fa-pencil" title="edit"></i>',$value).'&nbsp;  ';
    ...
    <?php if($action== "edit"){?>
     <div class="row">
                ...
                <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout1');
                                  echo form_open_multipart('admin/connectchannels/update/'.$id,$attributes); ?>
                      ...
                      <!--input type="hidden" name="id" value="<?php echo $id;?>"/>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" required name="content" id="aboutcontent" cols="30" rows="10" ><?php if(isset($content)){
                      echo $content; }
                      ?></textarea>
       ...
       <?php if($action== "add"){?>
             <div class="panel-body">
                ...
                <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout');
                                  echo form_open_multipart('admin/connectchannels/add',$attributes); ?>
                  <span class="error"><?php echo validation_errors();?></span>
                                        <div class="form-group">
                                            <label><font color="#CC0000">*</font>About Title</label>
                                           <input class="form-control " required name="title" value="<?php if(isset($title)){echo $title; }?>" type="text">
                      ...
                      <!--input type="hidden" name="id" value="<?php echo $id;?>"/>-->
                                        ...
                                        <div class="form-group">
                                            <label><font color="#CC0000">*</font>Content</label>
                                           <textarea class="form-control" id="aboutcontent" required name="content"  ><?php if(isset($content)){
                      echo $content; }
                      ?></textarea>
