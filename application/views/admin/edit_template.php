                        ...
                        <div class="panel-body">
							...
							<div class="col-lg-1">
                                ...
                                <div class="col-lg-6">
                                 ...
                                 echo  form_open_multipart('admin/edit_template',$attributes); ?>   
										...
										<input type="hidden" name="hidimage" value="default_adminuser.jpg" >
											<img src="<?php echo base_url(); ?>uploads/<?php echo $img;?>" class="img_profile" width="150px" height="150px">		<img class="img_profile_loading" src="<?php echo base_url(); ?>assets/img/loading.gif" style="position:absolute; top:40px; left:0;left: 60px; height: 30px;display: none; " />
												  </div>
                                        </div>
