<?php $this->load->view('admin/header');?>
  ...
  <i class="fa fa-home"></i> PMS Integration CMS
  </div>
  </div>
  ...
  <div class="manage">
    ...
    <?php     
          ...
          <?php }?> 
       <?php 
          if($action== "add") $title ="Add PMS Integration CMS" ;
          else if($action== "edit") $title ="Edit PMS Integration CMS" ;
          else if($action== "view_single" || $action== "view") $title ="View PMS Integration CMS";
        ?>
      <div class="col-md-12">
...
<?php if($action== "view"){?>
      ...
      cellspacing="0">
        ...
        echo anchor('admin/integration/edit/'.$row->id,'<i class="fa fa-pencil" title="edit"></i>',$value).'&nbsp;';
 ...
 <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-lg-6">
                    <?php echo form_open_multipart('admin/integration/update/'.$id); ?>
        ...
        <div class="row">
          <div class="col-lg-12"><div class="col-lg-1"></div>
            ...
            <?php $attributes=array('class'=>'form form-horizontal','id'=>'addservice');
                         echo  form_open_multipart('admin/integration/add',$attributes); ?>   
            <span class="error"><?php echo validation_errors();?></span>
                    <div class="form-group">
                                    <label><font color="#CC0000">*</font>Title</label>
