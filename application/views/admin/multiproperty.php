<?php $this->load->view('admin/header');?>
  ...
  <i class="fa fa-home"></i> Multiproperty
  </div>
  </div>
  ...
  <div class="manage">
    ...
    <?php     
          ...
          <?php }?> 
       <?php 
          if($action== "add") $title ="Add Multiproperty" ;
          else if($action== "edit") $title ="Edit Multiproperty" ;
          else if($action== "view_single" || $action== "view") $title ="View Multiproperty";
        ?>
      <div class="col-md-12">
...
<?php if($action== "view"){?>
      ...
      cellspacing="0">
        ...
        echo anchor('admin/multiproperty/edit/'.$row->id,'<i class="fa fa-pencil" title="edit"></i>',$value).'&nbsp;  ';
    ...
    <?php if($action== "edit"){?>
     <div class="row">
                ...
                <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout1');
                                  echo form_open_multipart('admin/multiproperty/update/'.$id,$attributes); ?>
       ...
       <?php if($action== "add"){?>
             <div class="panel-body">
                ...
                <?php $attributes=array('class'=>'form form-horizontal','id'=>'addabout');
                                  echo form_open_multipart('admin/multiproperty/add',$attributes); ?>
                  <span class="error"><?php echo validation_errors();?></span>
                                        <div class="form-group">
