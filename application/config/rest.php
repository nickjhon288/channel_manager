...
|
*/
$config['rest_keys_table'] = 'partners';
...
/*
|--------------------------------------------------------------------------
| REST IP WhiteListing
|--------------------------------------------------------------------------
|
| Set to TRUE to allow only List Of IP's Mentioned at IP Whitelist Array
| 
|	TRUE
|
*/
$config['rest_ip_whitelist_enabled'] = TRUE;
$config['rest_ip_whitelist'] = '117.218.244.239,117.232.68.202';
$config['rest_enable_password'] = TRUE;
