...
class Mapping_model extends CI_Model
{
      ...
      function SaveConvertion()
    {
    	...
    	$import_mapping_ids = implode(",",$this->input->post('import_mapping_ids'));
    	$ValConvertion = $this->input->post('Conversion')/100;

    	$this->db->query("update roommapping  set rate_conversion = $ValConvertion where import_mapping_id in ($import_mapping_ids )");
