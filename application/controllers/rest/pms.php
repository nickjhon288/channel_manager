...
class Pms extends REST_Controller
{
        ...
        if($partner->num_rows() != 0)
        {
            ...
            if($property_exists->num_rows() != 0)
            {
                if($xmlData->SetChannels->Channels->Channel){
                    ...
                    $channeldata = get_data(MEMBERSHIP,array('user_id'=>$property_exists->row()->owner_id,'hotel_id'=>$hotel_id,'plan_status' => 1));
                    if($channeldata->num_rows() != 0)
                    {
                        ...
                        if($plandetails->num_rows() != 0)
                        {
                            ...
                            if(count($channels) < $plandetails)
                            {
                                ...
                                $error = array(
                                    'Status' => 'false',
                                    'Error' => 'You can connect upto '.$plandetails.' channels.Upgrade your plan for more channels',
                                );
                                $this->response(array('SetChannel'=>$error), 404);
                            }
                        }else{
                        ...
                        $error = array(
                            'Status' => 'false',
                            'Error' => 'You have to purchase a plan to connect a channels',
                        );
                        $this->response(array('SetChannel'=>$error), 404);
                    }
                }else{
    ...
    // PMS Booking Reservation 22/11/2016
