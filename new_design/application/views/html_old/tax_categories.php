...
<li class="active"><a href="">  Tax categories  </a></li>
...
<th width="30%"> Included in price    </th>			
           ...
           <tbody>
            <tr> 
          <td><a href="javascript:;" onclick="return edit_taxcat('1');"> test </a> </td>
             <td> 10 </td>
			 <td> <a href="javascript:;" onclick="return edit_taxcat('1');"> yes </a>  </td>
              </tr>
			   <tr> 
          <td><a href="javascript:;" onclick="return edit_taxcat('1');"> test </a> </td>
             <td> 10 </td>
