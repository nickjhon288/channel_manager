    ...
    <div class="clk_history dep_his pay_tab_clr">
      ...
      <thead> 
       ...
       <th width="5%"> Active </th>
        <th width="11%"> Name </th>
          <th width="16%"> Provider  </th> 		 
         </tr>
          </thead>
           <tbody>
            <tr> 
            <td align="center"><button type="button" class="btn   btn-danger  btn-sm" id="cash_status_id_1">No </button></td>
            <td>cash </td>
             <td><a href="javascript:;" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#cash"> Cash </a></td> 
              </tr>
			  
			  <tr> 
            <td align="center"><button type="submit" class="btn  btn-success  btn-sm"> yes </button></td>
            <td>cash </td>
             <td><a href="javascript:;" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#cash"> Cash </a></td> 
              </tr>
