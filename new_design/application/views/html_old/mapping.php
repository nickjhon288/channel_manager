   ...
   <div class="row">
     <div class="col-md-3 col-sm-6 col-xs-12 cls_resp50">
    	<div class="cls_conn_chan_blk">
    	  <h4><a href=""><i class="fa fa-building" aria-hidden="true"></i> Booking.com</a></h4>
          <button type="button" class="btn btn-success">Enabled</button>
	      <h4>1 Rooms mapped</h4>
          <button type="button" class="btn txt_setng"><i class="fa fa-cog"></i>Settings</button>
    	  </div>
	  </div>
     <div class="col-md-3 col-sm-6 col-xs-12 cls_resp50">
    	<div class="cls_conn_chan_blk">
    	  <h4><a href=""><i class="fa fa-building" aria-hidden="true"></i> Hostelworld </a></h4>
          <button type="button" class="btn btn-success">Enabled</button>
	      <h4>0 Rooms mapped</h4>
          <button type="button" class="btn txt_setng"><i class="fa fa-cog"></i>Settings</button>
    	  </div>
	  </div>
     <div class="col-md-3 col-sm-6 col-xs-12 cls_resp50">
     ...
     <div class="col-md-3 col-sm-6 col-xs-12 cls_resp50">
    	<div class="cls_conn_chan_blk">
    	  <h4><a href=""><i class="fa fa-building" aria-hidden="true"></i> Reconline </a></h4>
          <button type="button" class="btn btn-danger">Disabled</button>
	      <h4>7 Rooms mapped</h4>
          <button type="button" class="btn txt_setng"><i class="fa fa-cog"></i>Settings</button>
    	  </div>
