...
<div class="row">
	<div class="col-md-4">
		...
		<div class="col-md-2">
		  ...
		  <div class="form-wrapper marB50 marT50 pull-left">
			...
			<label class="col-md-2 mar-top7">From</label>		  
			  <div class="col-md-8"> 
				<input type="text" id="average_from_date" value="<?php echo $from_date; ?>" name="from_date" class="form-control">
		  ...
		  <label class="col-md-2 mar-top7">To</label>
			  <div class="col-md-8"> 
				<input type="text" id="average_to_date" value="<?php echo $to_date; ?>" class="form-control">
			  </div>
		  </div>
