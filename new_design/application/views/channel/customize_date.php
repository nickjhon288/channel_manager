...
foreach($period as $date)
{
	...
	if(in_array($ss_da,$da))
	{
		...
		?>
	<td class="<?php echo $color?> tal_td_bor" >
    <div class="g-top-n ji pull-left" style="clear:both; overflow:hidden; text-align:center !important;" align="center"><span title="Minimum Stay"> M </span><span><?php echo get_data(TBL_CUR,array('currency_id'=>$currency))->row()->symbol.intval(str_replace(',','',$sub_rate));?></span>
    </div></td>
