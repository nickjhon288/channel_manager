...
<div class="nav-side-menu">
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content out">
                <li>  
                  <a href="<?php echo base_url();?>reservation/report_revenue"  <?php if(uri(3)=='report_revenue'){?>class="acc-mn"<?php } ?>>
                  <i class="fa fa-money fa-lg"></i> Revenue
                  </a>
                </li>
                 <li>
                  <a href="<?php echo base_url();?>reservation/report_reservation" <?php if(uri(3)=='report_reservation'){?>class="acc-mn"<?php } ?>>
                  <i class="fa fa-calendar fa-lg"></i> Reservations
                  </a>
                </li>

                <li>
                  <a href="<?php echo base_url();?>reservation/nights_revenue" <?php if(uri(3)=='nights_revenue'){?>class="acc-mn"<?php } ?>>
                ...
                <li>
                  <a href="<?php echo base_url();?>reservation/report_guest" <?php if(uri(3)=='report_guest'){?>class="acc-mn"<?php } ?>>
                  <i class="fa fa-user fa-lg"></i>Guests </a>
                </li>  
                

                 <li>
                  <a href="<?php echo base_url();?>reservation/average_revenue" <?php if(uri(3)=='average_revenue'){?>class="acc-mn"<?php } ?>>
...
<div class="bg-neww">
<div class="pa-n nn2"><h4><a href="<?php echo base_url();?>inventory/inventory_dashboard">My Property</a>
	...
	<div class="col-md-2">
          <div class="form-wrapper marB10 marT10 pull-left">
            ...
            <div class="btn-group text-left">
				...
				<select value="selected" id="report_guests" class="form-control" onchange="return report_guest();">
					<?php 
		  ...
		  <div class="col-md-2">
            ...
            <div class="btn-group text-right">
				...
				<select value="selected" id="channel_guests" class="form-control" onchange="return report_guest();">
		 ...
		 <label class="col-md-2 mar-top7">From</label>
		  <div class="col-md-10"> 
			...
			<input type="text" id="guest_from_date" name="from_date" class="form-control">
		  </div>
		</div>
		...
		<div class="col-md-4"> 
		  <label class="col-md-2 mar-top7">To</label>
			  <div class="col-md-10"> 
				<input type="text" id="guest_to_date" class="form-control">
			  </div>
		  </div>
...
<div class="box-m">
	...
	<div class="chart-container">
        ...
        <input type="hidden" value="Guest" id="show_text" name="show_text" />
