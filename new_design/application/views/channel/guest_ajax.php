	...
	<div class="col-md-4">
		 ...
		 <label class="col-md-2 mar-top7">From</label>
		  <div class="col-md-8"> 
			...
			<input type="text" id="guest_from_date" value="<?php echo $from_date; ?>" name="from_date" class="form-control">
		  </div>
		</div>
		...
		<div class="col-md-3"> 
		  <label class="col-md-2 mar-top7">To</label>
			  <div class="col-md-8"> 
				<input type="text" id="guest_to_date" value="<?php echo $to_date; ?>" class="form-control">
			  </div>
		  </div>
