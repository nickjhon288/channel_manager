...
?>
  ...
  <section style=" float: left; height: 100%;  padding: 0;width: 46%;">
    ...
    ?>
        <p style="padding: 0 10px;"><label>Subtotal:</label><span><?php echo $currency; ?> <?php if($curr_cha_id != 1 && $curr_cha_id != 8&& $curr_cha_id != 5) { echo $price*$nt; }else{ echo $price; } ?></span>
        </p>
        <p style="padding: 0 10px;"><label>Grand total:</label><span><?php echo $currency; ?> <?php if($curr_cha_id != 1 && $curr_cha_id != 8 && $curr_cha_id != 5) { echo $price*$nt; }else{ echo $price; } ?></span>
        </p>
...
<tr>
  ...
  <section class="clearfix"></section>
    ...
    <p style="padding: 0 10px;"><label>Adult count:</label><span>
      <?php echo $members_count; ?>
    </span></p>
	<p style="padding: 0 10px;"><label>Child count:</label><span>
      <?php echo $children; ?>
    </span></p>
  ...
  <section style="  float: left; height: 100%; padding: 0; position: relative;
    ...
    <p style="padding: 0 10px;"><label>Total
      :</label><span> <?php echo $currency; ?> <?php if($curr_cha_id != 1 && $curr_cha_id != 8 && $curr_cha_id != 5){ echo $price*$num_nights; }else{ echo $price; } ?></span>
    </p>
  </section>
  <section class="clearfix"></section>
  ...
  <section style="clear:both;overflow:hidden"></section>
    ...
    padding: 8px; width: 50%;">
                        ...
                        <?php echo $currency; ?> <?php echo $curr_cha_id=='5' ? number_format((float)$price/$num_nights, 2, '.', '') : $price; ?>
                  </td>
            </tr>
          <?php } ?>
          <?php }else { 
    ...
    padding: 8px; width: 50%;">
                        ...
                        <?php echo $curr_cha_id=='5' ? number_format((float)$val, 2, '.', '') : $val; //echo $val; ?> <?php echo $currency; ?> 
                  </td>
            </tr>
          <?php } } }}else{ ?>  <td style="border: 1px solid #d9d9d9; line-height: 1.42857;
    padding: 8px; width: 50%;">
    <?php echo date('M d, Y' , strtotime($start_date)). " - ".date('M d, Y' , strtotime($end_date)); ?> </td>  
	
	<td style="border: 1px solid #d9d9d9; line-height: 1.42857;
    padding: 8px; width: 50%;">

    <?php echo $price; ?> </td> <?php } }?>
      </tbody></table>
    </div>
