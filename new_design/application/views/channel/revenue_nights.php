...
<div class="nav-side-menu">
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content out">
                <li>  
                  <a href="<?php echo lang_url();?>reservation/report_revenue"  <?php if(uri(2)=='report_revenue'){?>class="acc-mn"<?php } ?>>
                  <i class="fa fa-money fa-lg"></i> Revenue
                  </a>
                </li>
                 <li>
                  <a href="<?php echo lang_url();?>reservation/report_reservation" <?php if(uri(2)=='report_reservation'){?>class="acc-mn"<?php } ?>>
...
<div class="row">
		<div class="col-md-2">
          ...
          <div class="form-wrapper marB10 marT10 pull-left">
            ...
            <div class="btn-group text-left">
				...
				<select value="selected" id="report_night" class="form-control" onchange="return nights_report();">
					<?php 
		  ...
		  <div class="col-md-2">
		   ...
		   <div class="form-wrapper marB10 marT10 pull-left">
            ...
            <div class="btn-group text-left">
				...
				<select value="selected" id="channel_night" class="form-control" onchange="return nights_report();">
		...
		<div class="col-md-4"> 
		 <label class="col-md-2 mar-top7">From</label>
		  <div class="col-md-10"> 
			<input type="text" id="night_from_date" name="from_date" class="form-control">
		  </div>
		</div>
		...
		<div class="col-md-4"> 
		  <label class="col-md-2 mar-top7">To</label>
			  <div class="col-md-10"> 
				<input type="text" id="night_to_date" class="form-control">
			  </div>
		  </div>
...
<input type="hidden" value="Nights" id="show_text" name="show_text" />
