...
<?php if(uri(3)=='property_info' || 	uri(3)=='tax_categories' || uri(3)=='policies' || uri(3)=='manage_subusers' || uri(3)=='billing_info' ||  uri(3)=='manage_rooms' || uri(3)=='payment_list' || uri(3)=='payment_bank' || uri(3)=='rate_management' || uri(3)=='manage_channel') {?>
