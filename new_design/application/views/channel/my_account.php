...
<div class="nav-side-menu">
  ...
  <div class="tab-room"><div class="new-left-menu"><div class="nav-side-menu"><div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content out">
                <li <?php if(uri(3)=='my_account') {?>class="active" <?php } ?>	> 
                  <a href="#tab_default_1" data-toggle="tab">
                  <i class="fa fa-user-md fa-lg"></i> Profile 
                  </a>
                </li>
				
                 <!--<li <?php //if(uri(3)=='manage_credit_cards') {?>class="active" <?php //} ?>>
                  <a href="#tab_default_2" data-toggle="tab" > 
                  <i class="fa fa fa-credit-card fa-lg"></i> Credit Cards
                  </a>
                </li>-->
                <!--<li <?php //if(uri(3)=='manage_rooms') {?>class="active" <?php //} ?>>
                  <a href="#tab_default_3" data-toggle="tab">
                  <i class="fa fa-home fa-lg"></i> Rooms
                  </a>
                  </li>-->
               ...
               <!-- <li <?php //if(uri(3)=='manage_users') {?>class="active" <?php //} ?>>
                  <a href="#tab_default_4" data-toggle="tab">
                  <i class="fa fa-users fa-lg"></i> Users
                  </a>
                </li>-->
				
				 <li <?php if(uri(3)=='change_password') {?>class="active" <?php } ?>>
                  <a href="#tab_default_5" data-toggle="tab">
                  <i class="fa fa-user-md fa-lg"></i> Change Password
                  </a>
                </li>
...
<!-- change password -->
<div class="tab-pane <?php if(uri(3)=='change_password') {?>active <?php } ?>" id="tab_default_5"><!-- tab1 -->
<div class="pa-n nn2"><h4><a href="#">My Account</a>
    <i class="fa fa-angle-right"></i>
    change Password 
</h4></div>
...
<?php $error = $this->session->flashdata('error'); 
	...
	<form id="change_password" method="post" action="<?php echo lang_url();?>channel/change_password">

	<div class="row proper2">
		<div class="col-md-2 col-sm-2">Old Password <span class="errors">*</span></div>
			<div class="col-md-6 col-sm-6"><input type="password" class="form-control" id="old_pass" required name="old_pass" value=""></div>
	</div>
	
	<div class="row proper2">
		<div class="col-md-2 col-sm-2">New Password <span class="errors">*</span></div>
			<div class="col-md-6 col-sm-6"><input type="password" class="form-control" id="new_pass" name="new_pass" value="<?php ?>" required></div>
	</div>

	<div class="row proper2">
		<div class="col-md-2 col-sm-2">Confirm Password <span class="errors">*</span></div>
			<div class="col-md-6 col-sm-6"><input type="password" class="form-control" required id="confirm_pass" name="confirm_pass" value="<?php ?>"></div>
...
<!-- Credit Start -->
	...
	<div class="bg-neww">
		...
		<div class="pa-n nn2">
		<h4><a href="javascript:;">My Account</a>
			<i class="fa fa-angle-right"></i>
			Credit Card
		</h4>
		</div>
...
<div class="modal fade dialog-2 " id="M_credit_<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <form role="form" class="form-horizontal cls_mar_top" name="card" id="card_<?php echo $i;?>" method="post" action="<?php echo lang_url();?>channel/manage_credit_cards/update">
...
First Name <span class="errors">*</span></p>
    <div class="col-sm-6">
      <input type="text" placeholder="First Name" id="c_fname" name="c_fname" class="form-control" value="<?php echo $c_fname;?>">
    </div>
  </div>
...
Last Name <span class="errors">*</span></p>
    <div class="col-sm-6"> 
      <input type="text" placeholder="Last Name" id="c_lname" name="c_lname" class="form-control" value="<?php echo $c_lname;?>">
    </div>
  </div>
...
<td><?php echo ucfirst($users->email_address); ?></td>
<!--<td><?php 
$user_acc='';
...
<td>
    ...
    &nbsp;
    <a href="<?php echo lang_url();?>channel/manage_users/delete/<?php echo insep_encode($users->user_id);?>" class=""> <i class="fa fa-trash-o text-danger" title="Delete this user" custom="<?php echo $ii;?>"> </i></a>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body sign-up-m">
     ...
     <div class="row">
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
		...
		<div class="col-sm-7">
		  <input type="email" placeholder="User Email" id="user_email_e<?php echo $ii;?>" name="user_email_e<?php echo $ii;?>" class="form-control" value="<?php echo $users->email_address; ?>">
		</div>
	  </div>
	 ...
	 <!-- <div class="form-group">
		...
		<input type="checkbox" class="select_name" value="<?php echo $acc_id?>" <?php if(in_array($acc_id,$user_access)){?> checked="checked" <?php } ?>name="access[]" id="access" /> <?php echo $acc_name?> 
