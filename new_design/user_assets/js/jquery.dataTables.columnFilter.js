...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
           // style ="width:200px; float:left; margin-right:20px;" var from = $('<input type="text" class="date_range_filter form-control" style ="float:left;" id="' + sFromId + '" rel="' + i + '"/>');
		   var from = $('<input type="text"  style ="height:35px;" placeholder="From" class="date_range_filter form-controls col-md-6" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            //style ="width:200px" var to = $('<input type="text" class="date_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
			var to = $('<input type="text"   style ="height:35px;" placeholder="To" class="date_range_filter form-controls col-md-6" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel) {
           ...
           //var r = '<select class="search_init select_filter form-control"><option value="" class="search_init">  </option>';
		   var r = '<select class="search_init select_filter form-control" onchange="getreserve_channel(this.value)"><option value="" class="search_init"> </option>';
             var j = 0;
