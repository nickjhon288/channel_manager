...
module.exports = {
  ...
  hotl_id:'This field is required',
    ...
    steps: {
      ...
      buildNavItems: function(i) {
        ...
        return this.opts.steps.i18n.step +' '+ (i+1);
			...
			return this.opts.steps.i18n1.step +' '+ (i+1);  
		  }
		  else if(i==2){
			return this.opts.steps.i18n2.step +' '+ (i+1);  
		  }
		  else if(i==3){
			return this.opts.steps.i18n3.step +' '+ (i+1);  
		  }
      },
      wrap: '.idealsteps-wrap',
      step: '.idealsteps-step',
