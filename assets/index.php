...
function et($tag){
    ...
    $pt['SaveConfig'] = 'Salvar ConfiguraÃ§Ãµes';
    ...
    $pt['Configurations'] = 'ConfiguraÃ§Ãµes';
    $pt['JSError'] = 'Erro de JavaScript';
    $pt['NoSel'] = 'NÃ£o hÃ¡ itens selecionados';
    $pt['SelDir'] = 'Selecione o diretÃ³rio de destino na Ã¡rvore a esquerda';
    $pt['TypeDir'] = 'Digite o nome do diretÃ³rio';
    ...
    $pt['NoDestDir'] = 'NÃ£o hÃ¡ um diretÃ³rio de destino selecionado';
    $pt['DestEqOrig'] = 'DiretÃ³rio de origem e destino iguais';
    $pt['InvalidDest'] = 'DiretÃ³rio de destino invÃ¡lido';
    $pt['NoNewPerm'] = 'Nova permissÃ£o nÃ£o foi setada';
    $pt['CopyTo'] = 'COPIAR para';
    $pt['MoveTo'] = 'MOVER para';
    $pt['AlterPermTo'] = 'ALTERAR PERMISSÃ•ES para';
    $pt['ConfExec'] = 'Confirma EXECUTAR';
    $pt['ConfRem'] = 'Confirma APAGAR';
    $pt['EmptyDir'] = 'DiretÃ³rio vazio';
    $pt['IOError'] = 'Erro de E/S';
    $pt['FileMan'] = 'PHP File Manager';
    $pt['TypePass'] = 'Digite a senha';
    $pt['InvPass'] = 'Senha InvÃ¡lida';
    $pt['ReadDenied'] = 'Acesso de leitura negado';
    $pt['FileNotFound'] = 'Arquivo nÃ£o encontrado';
    $pt['AutoClose'] = 'Fechar Automaticamente';
    $pt['OutDocRoot'] = 'Arquivo fora do DOCUMENT_ROOT';
    $pt['NoCmd'] = 'Erro: Comando nÃ£o informado';
    $pt['ConfTrySave'] = 'Arquivo sem permissÃ£o de escrita.\\nTentar salvar assim mesmo';
    $pt['ConfSaved'] = 'ConfiguraÃ§Ãµes salvas';
    $pt['PassSaved'] = 'Senha salva';
    $pt['FileDirExists'] = 'Arquivo ou diretÃ³rio jÃ¡ existe';
    $pt['NoPhpinfo'] = 'FunÃ§Ã£o phpinfo desabilitada';
    $pt['NoReturn'] = 'sem retorno';
    $pt['FileSent'] = 'Arquivo enviado';
    $pt['SpaceLimReached'] = 'Limite de espaÃ§o alcanÃ§ado';
    $pt['InvExt'] = 'ExtensÃ£o invÃ¡lida';
    $pt['FileNoOverw'] = 'Arquivo nÃ£o pode ser sobreescrito';
    $pt['FileOverw'] = 'Arquivo sobreescrito';
    $pt['FileIgnored'] = 'Arquivo omitido';
    $pt['ChkVer'] = 'Verificar por nova versÃ£o';
    $pt['ChkVerAvailable'] = 'Nova versÃ£o, clique aqui para iniciar download!!';
    $pt['ChkVerNotAvailable'] = 'NÃ£o hÃ¡ nova versÃ£o disponÃ­vel. :(';
    $pt['ChkVerError'] = 'Erro de conexÃ£o.';
    $pt['Website'] = 'Website';
    ...
    $pt['Total'] = 'total';
    $pt['Partition'] = 'PartiÃ§Ã£o';
    $pt['RenderTime'] = 'Tempo para gerar esta pÃ¡gina';
    $pt['Seconds'] = 'seg';
    ...
    $es['SavePass'] = 'Cuardar ContraseÃ±a';
    ...
    $es['TypePass'] = 'Escriba la contraseÃ±a';
    $es['InvPass'] = 'ContraseÃ±a invalida';
    ...
    $es['PassSaved'] = 'ContraseÃ±a guardada';
	...
	// Korean - by Airplanez
    $kr['Version'] = 'ë²„ì „';
    $kr['DocRoot'] = 'ì›¹ì„œë²„ ë£¨íŠ¸';
    $kr['FLRoot'] = 'íŒŒì¼ ë§¤ë‹ˆì € ë£¨íŠ¸';
    $kr['Name'] = 'ì´ë¦„';
    $kr['Enter'] = 'ìž…ë ¥';
    $kr['Send'] = 'ì „ì†¡';
    $kr['Refresh'] = 'ìƒˆë¡œê³ ì¹¨';
    $kr['SaveConfig'] = 'í™˜ê²½ ì €ìž¥';
    $kr['SavePass'] = 'ë¹„ë°€ë²ˆí˜¸ ì €ìž¥';
    $kr['SaveFile'] = 'íŒŒì¼ ì €ìž¥';
    $kr['Save'] = 'ì €ìž¥';
    $kr['Leave'] = 'ë‚˜ê°€ê¸°';
    $kr['Edit'] = 'ìˆ˜ì •';
    $kr['View'] = 'ë³´ê¸°';
    ...
    $kr['Rem'] = 'ì‚­ì œ';
    $kr['Compress'] = 'ì••ì¶•í•˜ê¸°';
    $kr['Decompress'] = 'ì••ì¶•í’€ê¸°';
    $kr['ResolveIDs'] = 'ì†Œìœ ìž';
    $kr['Move'] = 'ì´ë™';
    $kr['Copy'] = 'ë³µì‚¬';
    $kr['ServerInfo'] = 'ì„œë²„ ì •ë³´';
    $kr['CreateDir'] = 'ë””ë ‰í† ë¦¬ ìƒì„±';
    $kr['CreateArq'] = 'íŒŒì¼ ìƒì„±';
    $kr['ExecCmd'] = 'ëª…ë ¹ ì‹¤í–‰';
    $kr['Upload'] = 'ì—…ë¡œë“œ';
    $kr['UploadEnd'] = 'ì—…ë¡œë“œê°€ ì™„ë£Œë˜ì—ˆìŠµë‹ˆë‹¤.';
    $kr['Perm'] = 'ê¶Œí•œ';
    $kr['Perms'] = 'ê¶Œí•œ';
    $kr['Owner'] = 'ì†Œìœ ìž';
    $kr['Group'] = 'ê·¸ë£¹';
    $kr['Other'] = 'ëª¨ë“ ì‚¬ìš©ìž';
    $kr['Size'] = 'í¬ê¸°';
    $kr['Date'] = 'ë‚ ì§œ';
    $kr['Type'] = 'ì¢…ë¥˜';
    $kr['Free'] = 'ì—¬ìœ ';
    ...
    $kr['Exec'] = 'ì‹¤í–‰';
    $kr['Apply'] = 'ì ìš©';
    $kr['StickyBit'] = 'ìŠ¤í‹°í‚¤ ë¹„íŠ¸';
    $kr['Pass'] = 'ë¹„ë°€ë²ˆí˜¸';
    $kr['Lang'] = 'ì–¸ì–´';
    $kr['File'] = 'íŒŒì¼';
    $kr['File_s'] = 'íŒŒì¼';
    $kr['To'] = 'ìœ¼ë¡œ';
    $kr['Destination'] = 'ëŒ€ìƒ';
    $kr['Configurations'] = 'í™˜ê²½';
    $kr['JSError'] = 'ìžë°”ìŠ¤í¬ë¦½íŠ¸ ì˜¤ë¥˜';
    $kr['NoSel'] = 'ì„ íƒëœ ê²ƒì´ ì—†ìŠµë‹ˆë‹¤';
    $kr['SelDir'] = 'ì™¼ìª½ë¦¬ìŠ¤íŠ¸ì—ì„œ ëŒ€ìƒ ë””ë ‰í† ë¦¬ë¥¼ ì„ íƒí•˜ì„¸ìš”';
    $kr['TypeDir'] = 'ë””ë ‰í† ë¦¬ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $kr['TypeArq'] = 'íŒŒì¼ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $kr['TypeCmd'] = 'ëª…ë ¹ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $kr['TypeArqComp'] = 'íŒŒì¼ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”.\\ní™•ìž¥ìžì— ë”°ë¼ ì••ì¶•í˜•ì‹ì´ ì •í•´ì§‘ë‹ˆë‹¤.\\nì˜ˆ:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $kr['RemSel'] = 'ì„ íƒëœ ê²ƒì„ ì‚­ì œí–ˆìŠµë‹ˆë‹¤';
    $kr['NoDestDir'] = 'ì„ íƒëœ ëŒ€ìƒ ë””ë ‰í† ë¦¬ê°€ ì—†ìŠµë‹ˆë‹¤.';
    $kr['DestEqOrig'] = 'ì›ëž˜ ë””ë ‰í† ë¦¬ì™€ ëŒ€ìƒ ë””ë ‰í† ë¦¬ê°€ ê°™ìŠµë‹ˆë‹¤';
    $kr['NoNewPerm'] = 'ìƒˆë¡œìš´ ê¶Œí•œì´ ì„¤ì •ë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $kr['CopyTo'] = 'ì—¬ê¸°ì— ë³µì‚¬';
    $kr['MoveTo'] = 'ì—¬ê¸°ë¡œ ì´ë™';
    $kr['AlterPermTo'] = 'ìœ¼ë¡œ ê¶Œí•œë³€ê²½';
    $kr['ConfExec'] = 'ì‹¤í–‰ í™•ì¸';
    $kr['ConfRem'] = 'ì‚­ì œ í™•ì¸';
    $kr['EmptyDir'] = 'ë¹ˆ ë””ë ‰í† ë¦¬';
    $kr['IOError'] = 'ìž…/ì¶œë ¥ ì˜¤ë¥˜';
    $kr['FileMan'] = 'PHP íŒŒì¼ ë§¤ë‹ˆì €';
    $kr['TypePass'] = 'ë¹„ë°€ë²ˆí˜¸ë¥¼ ìž…ë ¥í•˜ì„¸ìš”';
    $kr['InvPass'] = 'ë¹„ë°€ë²ˆí˜¸ê°€ í‹€ë¦½ë‹ˆë‹¤';
    $kr['ReadDenied'] = 'ì½ê¸°ê°€ ê±°ë¶€ë˜ì—ˆìŠµë‹ˆë‹¤';
    $kr['FileNotFound'] = 'íŒŒì¼ì´ ì—†ìŠµë‹ˆë‹¤';
    $kr['AutoClose'] = 'ì™„ë£Œí›„ ë‹«ê¸°';
    $kr['OutDocRoot'] = 'DOCUMENT_ROOT ì´ë‚´ì˜ íŒŒì¼ì´ ì•„ë‹™ë‹ˆë‹¤';
    $kr['NoCmd'] = 'ì˜¤ë¥˜: ëª…ë ¹ì´ ì‹¤í–‰ë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $kr['ConfTrySave'] = 'íŒŒì¼ì— ì“°ê¸° ê¶Œí•œì´ ì—†ìŠµë‹ˆë‹¤.\\nê·¸ëž˜ë„ ì €ìž¥í•˜ì‹œê² ìŠµë‹ˆê¹Œ';
    $kr['ConfSaved'] = 'í™˜ê²½ì´ ì €ìž¥ë˜ì—ˆìŠµë‹ˆë‹¤';
    $kr['PassSaved'] = 'ë¹„ë°€ë²ˆí˜¸ ì €ìž¥';
    $kr['FileDirExists'] = 'íŒŒì¼ ë˜ëŠ” ë””ë ‰í† ë¦¬ê°€ ì´ë¯¸ ì¡´ìž¬í•©ë‹ˆë‹¤';
    $kr['NoPhpinfo'] = 'PHPINFO()ë¥¼ ì‚¬ìš©í• ìˆ˜ ì—†ìŠµë‹ˆë‹¤';
    $kr['NoReturn'] = 'ë°˜í™˜ê°’ ì—†ìŒ';
    $kr['FileSent'] = 'íŒŒì¼ ì „ì†¡';
    $kr['SpaceLimReached'] = 'ì €ìž¥ê³µê°€ ì—¬ìœ ê°€ ì—†ìŠµë‹ˆë‹¤';
    $kr['InvExt'] = 'ìœ íš¨í•˜ì§€ ì•Šì€ í™•ìž¥ìž';
    $kr['FileNoOverw'] = 'íŒŒì¼ì„ ë®ì–´ ì“¸ìˆ˜ ì—†ìŠµë‹ˆë‹¤';
    $kr['FileOverw'] = 'íŒŒì¼ì„ ë®ì–´ ì¼ìŠµë‹ˆë‹¤';
    $kr['FileIgnored'] = 'íŒŒì¼ì´ ë¬´ì‹œë˜ì—ˆìŠµë‹ˆë‹¤';
    $kr['ChkVer'] = 'ì—ì„œ ìƒˆë²„ì „ í™•ì¸';
    $kr['ChkVerAvailable'] = 'ìƒˆë¡œìš´ ë²„ì „ì´ ìžˆìŠµë‹ˆë‹¤. ë‹¤ìš´ë°›ìœ¼ë ¤ë©´ í´ë¦­í•˜ì„¸ìš”!!';
    $kr['ChkVerNotAvailable'] = 'ìƒˆë¡œìš´ ë²„ì „ì´ ì—†ìŠµë‹ˆë‹¤. :(';
    $kr['ChkVerError'] = 'ì—°ê²° ì˜¤ë¥˜';
    $kr['Website'] = 'ì›¹ì‚¬ì´íŠ¸';
    $kr['SendingForm'] = 'íŒŒì¼ì„ ì „ì†¡ì¤‘ìž…ë‹ˆë‹¤. ê¸°ë‹¤ë¦¬ì„¸ìš”';
    $kr['NoFileSel'] = 'íŒŒì¼ì´ ì„ íƒë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $kr['SelAll'] = 'ëª¨ë“ ';
    $kr['SelNone'] = 'ì œë¡œ';
    $kr['SelInverse'] = 'ì—­';
    ...
    $de1['RemSel'] = 'LÃ–SCHE die selektierten Objekte';
    $de1['NoDestDir'] = 'Das selektierte Zielverzeichnis existiert nicht';
    $de1['DestEqOrig'] = 'Quell- und Zielverzeichnis stimmen Ã¼berein';
    $de1['InvalidDest'] = 'Zielverzeichnis ist ungÃ¼ltig';
    $de1['NoNewPerm'] = 'Neue Zugriffserlaubnis konnte nicht gesetzt werden';
    $de1['CopyTo'] = 'KOPIERE nach';
    $de1['MoveTo'] = 'VERSCHIEBE nach';
    $de1['AlterPermTo'] = 'Ã„NDERE ZUGRIFFSERLAUBSNIS in';
    $de1['ConfExec'] = 'BestÃ¤tige AUSFÃœHRUNG';
    $de1['ConfRem'] = 'BestÃ¤tige LÃ–SCHEN';
    ...
    $de1['InvPass'] = 'UngÃ¼ltiges Passwort';
    $de1['ReadDenied'] = 'Lesezugriff verweigert';
    $de1['FileNotFound'] = 'Datei nicht gefunden';
    $de1['AutoClose'] = 'SchlieÃŸen, wenn fertig';
    $de1['OutDocRoot'] = 'Datei auÃŸerhalb von DOCUMENT_ROOT';
    $de1['NoCmd'] = 'Fehler: Es wurde kein Kommando eingetragen';
    $de1['ConfTrySave'] = 'Keine Schreibberechtigung fÃ¼r die Datei.\\nVersuche trotzdem zu speichern';
    ...
    $de1['NoReturn'] = 'keine RÃ¼ckgabe';
    $de1['FileSent'] = 'Datei wurde gesendet';
    $de1['SpaceLimReached'] = 'VerfÃ¼gbares Speicherlimit wurde erreicht';
    $de1['InvExt'] = 'UngÃ¼ltige Dateiendung';
    $de1['FileNoOverw'] = 'Datei kann nicht Ã¼berschrieben werden';
    $de1['FileOverw'] = 'Datei Ã¼berschrieben';
    $de1['FileIgnored'] = 'Datei ignoriert';
    $de1['ChkVer'] = 'PrÃ¼fe auf neue Version';
    $de1['ChkVerAvailable'] = 'Neue Version verfÃ¼gbar; klicke hier, um den Download zu starten!!';
    ...
    $de2['NoSel'] = 'Keine EintrÃ¤ge ausgewÃ¤hlt';
    $de2['SelDir'] = 'WÃ¤hlen Sie das Zeilverzeichnis im Verzeichnis links';
    ...
    $de2['InvPass'] = 'UngÃ¼ltiges Passwort';
    ...
    $de2['NoReturn'] = 'keine RÃ¼ckgabe';
    $de2['FileSent'] = 'Datei versandt';
    $de2['SpaceLimReached'] = 'Plattenplatz erschÃ¶pft';
    $de2['InvExt'] = 'UngÃ¼ltige datei-Extension';
    $de2['FileNoOverw'] = 'Datei kann nicht Ã¼berschrieben werden';
    $de2['FileOverw'] = 'Datei Ã¼berschrieben';
    $de2['FileIgnored'] = 'Datei ignoriert';
    $de2['ChkVer'] = 'ÃœberprÃ¼fe neuer Version';
    $de2['ChkVerAvailable'] = 'Neue Version. Hier klicken fÃ¼r Download!!';
    $de2['ChkVerNotAvailable'] = 'Keine neue Version verfÃ¼gbar. :(';
    $de2['ChkVerError'] = 'Verbindungsfehler.';
    $de2['Website'] = 'Webseite';
    $de2['SendingForm'] = 'Sende Dateien, bitte warten';
    $de2['NoFileSel'] = 'Keine Dateien ausgewÃ¤hlt';
    $de2['SelAll'] = 'Alle';
    $de2['SelNone'] = 'Keine';
    $de2['SelInverse'] = 'Invers';
    $de2['Selected_s'] = 'ausgewÃ¤hlt';
    $de2['Total'] = 'Total';
    ...
    $fr1['CreateDir'] = 'CrÃ©er un rÃ©pertoire';
    $fr1['CreateArq'] = 'CrÃ©er un fichier';
    $fr1['ExecCmd'] = 'Executer une Commande';
    $fr1['Upload'] = 'TÃ©lÃ©versement(upload)';
    $fr1['UploadEnd'] = 'TÃ©lÃ©versement Fini';
    $fr1['Perm'] = 'Perm';
    $fr1['Perms'] = 'Permissions';
    $fr1['Owner'] = 'PropriÃ©taire';
    $fr1['Group'] = 'Groupe';
    $fr1['Other'] = 'Autre';
    $fr1['Size'] = 'Taille';
    $fr1['Date'] = 'Date';
    ...
    $fr1['Dir_s'] = 'rÃ©pertoire(s)';
    $fr1['To'] = 'Ã ';
    $fr1['Destination'] = 'Destination';
    $fr1['Configurations'] = 'Configurations';
    $fr1['JSError'] = 'Erreur JavaScript';
    $fr1['NoSel'] = 'Rien n\'est sÃ©lectionnÃ©';
    $fr1['SelDir'] = 'Selectionnez le rÃ©pertoire de destination dans le panneau gauche';
    $fr1['TypeDir'] = 'Entrer le nom du rÃ©pertoire';
    ...
    $fr1['RemSel'] = 'EFFACER les objets sÃ©lectionnÃ©s';
    $fr1['NoDestDir'] = 'Aucun rÃ©pertoire de destination n\'est sÃ©lectionnÃ©';
    $fr1['DestEqOrig'] = 'Les rÃ©pertoires source et destination sont identiques';
    $fr1['InvalidDest'] = 'Le rÃ©pertoire de destination est invalide';
    $fr1['NoNewPerm'] = 'Nouvelle permission non Ã©tablie';
    ...
    $fr1['EmptyDir'] = 'RÃ©pertoire vide';
    $fr1['IOError'] = 'I/O Error';
    $fr1['FileMan'] = 'PHP File Manager';
    $fr1['TypePass'] = 'Entrer le mot de passe';
    $fr1['InvPass'] = 'Mot de passe invalide';
    $fr1['ReadDenied'] = 'Droit de lecture refusÃ©';
    $fr1['FileNotFound'] = 'Fichier introuvable';
    $fr1['AutoClose'] = 'Fermer sur fin';
    $fr1['OutDocRoot'] = 'Fichier au delÃ  de DOCUMENT_ROOT';
    $fr1['NoCmd'] = 'Erreur: Commande non renseignÃ©e';
    $fr1['ConfTrySave'] = 'Fichier sans permission d\'Ã©criture.\\nJ\'essaie de l\'enregister';
    $fr1['ConfSaved'] = 'Configurations enreristrÃ©e';
    $fr1['PassSaved'] = 'Mot de passe enreristrÃ©';
    $fr1['FileDirExists'] = 'Le fichier ou le rÃ©pertoire existe dÃ©jÃ ';
    $fr1['NoPhpinfo'] = 'Function phpinfo dÃ©sactivÃ©e';
    $fr1['NoReturn'] = 'pas de retour';
    $fr1['FileSent'] = 'Fichier envoyÃ©';
    $fr1['SpaceLimReached'] = 'Espace maxi atteint';
    $fr1['InvExt'] = 'Extension invalide';
    $fr1['FileNoOverw'] = 'Le fichier ne peut pas etre Ã©crasÃ©';
    $fr1['FileOverw'] = 'Fichier Ã©crasÃ©';
    $fr1['FileIgnored'] = 'Fichier ignorÃ©';
    $fr1['ChkVer'] = 'Verifier nouvelle version';
    $fr1['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour la tÃ©lÃ©chager!!';
    ...
    $fr1['NoFileSel'] = 'Aucun fichier sÃ©lectionnÃ©';
    $fr1['SelAll'] = 'Tous';
    $fr1['SelNone'] = 'Aucun';
    $fr1['SelInverse'] = 'Inverser';
    $fr1['Selected_s'] = 'selectionÃ©';
    $fr1['Total'] = 'total';
    ...
    $fr2['Decompress'] = 'DÃ©compresser';
    $fr2['ResolveIDs'] = 'RÃ©soudre ID';
    $fr2['Move'] = 'DÃ©placer';
    $fr2['Copy'] = 'Copier';
    $fr2['ServerInfo'] = 'Information Serveur';
    $fr2['CreateDir'] = 'CrÃ©er un rÃ©pertoire';
    $fr2['CreateArq'] = 'CrÃ©er un fichier';
    $fr2['ExecCmd'] = 'ExecutÃ© une commande';
    $fr2['Upload'] = 'TransfÃ©rer';
    $fr2['UploadEnd'] = 'Transfert terminÃ©';
    $fr2['Perm'] = 'Perm';
    $fr2['Perms'] = 'Permissions';
    $fr2['Owner'] = 'PropriÃ©taire';
    $fr2['Group'] = 'Groupe';
    $fr2['Other'] = 'Autre';
    $fr2['Size'] = 'Taille';
    $fr2['Date'] = 'date';
    ...
    $fr2['Dir_s'] = 'rÃ©pertoire(s)';
    $fr2['To'] = 'Ã ';
    $fr2['Destination'] = 'Destination';
    $fr2['Configurations'] = 'Configurations';
    $fr2['JSError'] = 'Erreur JavaScript';
    $fr2['NoSel'] = 'Il n\'y a pas d\'objets sÃ©lectionnÃ©s';
    $fr2['SelDir'] = 'SÃ©lectionnez le rÃ©pertoire de destination sur l\'arborescence de gauche';
    $fr2['TypeDir'] = 'Entrez le nom du rÃ©pertoire';
    $fr2['TypeArq'] = 'Entrez le nom du fichier';
    $fr2['TypeCmd'] = 'Entrez la commande';
    $fr2['TypeArqComp'] = 'Entrez le fichier.\\nL\'extension dÃ©finira le type de compression.\\nEx:\\nnom.zip\\nnom.tar\\nnom.bzip\\nnom.gzip';
    $fr2['RemSel'] = 'EFFACEZ l\'objet sÃ©lectionnÃ©';
    $fr2['NoDestDir'] = 'Il n\'y a aucun rÃ©pertoire de destination sÃ©lectionnÃ©';
    $fr2['DestEqOrig'] = 'Origine et rÃ©pertoires de destination sont identique';
    $fr2['InvalidDest'] = 'RÃ©pertoire de destination est invalide';
    $fr2['NoNewPerm'] = 'Nouvelle autorisation n\'a pas Ã©tÃ© configurÃ©';
    $fr2['CopyTo'] = 'COPIE dans';
    $fr2['MoveTo'] = 'DÃ‰PLACER dans';
    $fr2['AlterPermTo'] = 'CHANGER PERMISSIONS dans';
    $fr2['ConfExec'] = 'Confirmer EXECUTE';
    $fr2['ConfRem'] = 'Confirmer EFFACER';
    $fr2['EmptyDir'] = 'RÃ©pertoire vide';
    ...
    $fr2['ReadDenied'] = 'AccÃ¨s en lecture refuser';
    $fr2['FileNotFound'] = 'Fichier non-trouvÃ©';
    $fr2['AutoClose'] = 'Fermez a la fin';
    $fr2['OutDocRoot'] = 'Fichier au-delÃ  DOCUMENT_ROOT';
    $fr2['NoCmd'] = 'Erreur: Commande inconnue';
    $fr2['ConfTrySave'] = 'Fichier sans permission d\'Ã©criture.\\nEssayez de sauver';
    $fr2['ConfSaved'] = 'Configurations sauvÃ©e';
    $fr2['PassSaved'] = 'Mot de passe sauvÃ©';
    $fr2['FileDirExists'] = 'Fichier ou rÃ©pertoire dÃ©jÃ  existant';
    $fr2['NoPhpinfo'] = 'Function phpinfo dÃ©sactivÃ©';
    $fr2['NoReturn'] = 'sans retour possible';
    $fr2['FileSent'] = 'Fichier envoyÃ©';
    $fr2['SpaceLimReached'] = 'Limite de d\'espace atteint';
    $fr2['InvExt'] = 'Extension invalide';
    $fr2['FileNoOverw'] = 'Fichier ne peut pas Ãªtre Ã©crasÃ©';
    $fr2['FileOverw'] = 'Fichier Ã©crasÃ©';
    $fr2['FileIgnored'] = 'Fichier ignorÃ©';
    $fr2['ChkVer'] = 'Check nouvelle version';
    $fr2['ChkVerAvailable'] = 'Nouvelle version, cliquez ici pour commencer le tÃ©lÃ©chargement!!';
    $fr2['ChkVerNotAvailable'] = 'Aucune nouvelle version disponible. :(';
    $fr2['ChkVerError'] = 'Erreur de connection.';
    $fr2['Website'] = 'Site Web';
    $fr2['SendingForm'] = 'Envoye de fichier, s\'il vous plaÃ®t patientez';
    $fr2['NoFileSel'] = 'Aucun fichier sÃ©lectionnÃ©';
    $fr2['SelAll'] = 'Tout';
    $fr2['SelNone'] = 'Aucuns';
    $fr2['SelInverse'] = 'Inverser';
    $fr2['Selected_s'] = 'sÃ©lectionnÃ©';
    $fr2['Total'] = 'total';
    ...
    $fr3['Dir_s'] = 'rÃ©pertoire(s)';
    $fr3['To'] = 'Ã ';
    $fr3['Destination'] = 'Destination';
    $fr3['Configurations'] = 'Configurations';
    $fr3['JSError'] = 'Erreur JavaScript';
    $fr3['NoSel'] = 'Aucun Ã©lÃ©ment sÃ©lectionnÃ©';
    $fr3['SelDir'] = "SÃ©lectionner le rÃ©pertoire de destination dans l'arboresence de gauchethe destination directory on the left tree";
    $fr3['TypeDir'] = 'Indiquer le nom du rÃ©pertoire';
    $fr3['TypeArq'] = 'Indiquer le nom du fichier';
    $fr3['TypeCmd'] = 'Entrer une commande';
    $fr3['TypeArqComp'] = "Indiquer le nom du fichier.\\nL'extension dÃ©finira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip";
    $fr3['RemSel'] = "SUPPRIMER l'Ã©lÃ©ment sÃ©lectionnÃ©";
    $fr3['NoDestDir'] = "Il n'y a pas de rÃ©pertoire destination sÃ©lectionnÃ©";
    $fr3['DestEqOrig'] = 'RÃ©pertoire Origine et Destination sont identiques';
    $fr3['InvalidDest'] = 'Le rÃ©pertoire de destination est invalide';
    $fr3['NoNewPerm'] = 'Nouvelle permission non appliquÃ©e';
    ...
    $fr3['EmptyDir'] = 'RÃ©pertoire vide';
    $fr3['IOError'] = 'Erreur entrÃ©e/sortie';
    $fr3['FileMan'] = 'PHP File Manager';
    $fr3['TypePass'] = 'Saisir le mot de passe';
    $fr3['InvPass'] = 'Mot de passe invalide';
    $fr3['ReadDenied'] = 'AccÃ¨s en lecture refusÃ©';
    $fr3['FileNotFound'] = 'Fichier non trouvÃ©';
    $fr3['AutoClose'] = 'Fermeture en fin de traitement';
    $fr3['OutDocRoot'] = 'Fichier en dessous de DOCUMENT_ROOT';
    $fr3['NoCmd'] = 'Erreur : Commande non renseignÃ©e';
    $fr3['ConfTrySave'] = "Fichier sans permission d'Ã©criture.\\nTenter de sauver malgrÃ© tout";
    $fr3['ConfSaved'] = 'Configurations sauvegardÃ©e';
    $fr3['PassSaved'] = 'Password sauvegardÃ©';
    $fr3['FileDirExists'] = 'Fichier ou rÃ©pertoire dÃ©jÃ  existant';
    $fr3['NoPhpinfo'] = 'Fonction phpinfo disactivÃ©e';
    $fr3['NoReturn'] = 'pas de retour';
    $fr3['FileSent'] = 'Fichier envoyÃ©';
    $fr3['SpaceLimReached'] = 'CapacitÃ© maximale atteinte';
    $fr3['InvExt'] = 'Extension invalide';
    $fr3['FileNoOverw'] = 'Fichier ne pouvant Ãªtre remplacÃ©';
    $fr3['FileOverw'] = 'Fichier remplacÃ©';
    $fr3['FileIgnored'] = 'Fichier ignorÃ©';
    $fr3['ChkVer'] = 'VÃ©rifier nouvelle version';
    $fr3['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour commencer le tÃ©lÃ©chargement !';
    ...
    $fr3['NoFileSel'] = 'Pas de fichier sÃ©lectionnÃ©';
    $fr3['SelAll'] = 'Tous';
    $fr3['SelNone'] = 'Aucun';
    $fr3['SelInverse'] = 'Inverser';
    $fr3['Selected_s'] = 'sÃ©lectionnÃ©';
    $fr3['Total'] = 'total';
    $fr3['Partition'] = 'Partition';
    $fr3['RenderTime'] = 'Temps nÃ©cessaire pour obtenir cette page';
    $fr3['Seconds'] = 'sec';
    ...
    $it1['NoDestDir'] = 'LA directory di destinazione non Ã¨ stata selezionata';
    $it1['DestEqOrig'] = 'La directory di origine e di destinazione sono la stessa';
    $it1['InvalidDest'] = 'La directory di destinazione non Ã¨ valida';
    ...
    $it1['FileDirExists'] = 'Il file o la directory esiste giÃ ';
    $it1['NoPhpinfo'] = 'La funzione phpinfo Ã¨ disabilitata';
    $it1['NoReturn'] = 'senza Return';
    $it1['FileSent'] = 'File inviato';
    $it1['SpaceLimReached'] = 'Ã¨ stato raggiunto il limite di spazio disponibile';
    $it1['InvExt'] = 'Estensione non valida';
    $it1['FileNoOverw'] = 'Il file non puÃ² essere sovrascritto';
    $it1['FileOverw'] = 'File sovrascritto';
    $it1['FileIgnored'] = 'File ignorato';
    $it1['ChkVer'] = 'Controlla se Ã¨ disponibile una nuova versione';
    $it1['ChkVerAvailable'] = 'Ã¨ disponibile una nuova versione: premi qui per scaricarla.';
    $it1['ChkVerNotAvailable'] = 'Non Ã¨ disponibile nessuna nuova versione. :(';
    ...
    $it2['NoDestDir'] = 'Non Ã¨ stata selezionata la cartella di destinazione';
    $it2['DestEqOrig'] = 'La cartella di origine e di destinazione coincidono';
    $it2['InvalidDest'] = 'La cartella di destinazione non Ã¨ valida';
    ...
    $it2['FileDirExists'] = 'Il file o la cartella esiste giÃ ';
    ...
    $it4['FileDirExists'] = 'Il file o la directory esistono giÃ ';
    ...
    $it4['FileNoOverw'] = 'Il file non puÃ² essere sovrascritto';
	...
	$ru['Version']='Ð’ÐµÑ€ÑÐ¸Ñ';
	$ru['DocRoot']='Ð”Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚ Root ';
	$ru['FLRoot']='Ð¤Ð°Ð¹Ð»Ð¾Ð²Ñ‹Ð¹ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€';
	$ru['Name']='Ð˜Ð¼Ñ';
	$ru['And']='Ð¸';
	$ru['Enter']='Enter';
	$ru['Send']='ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ';
	$ru['Refresh']='ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ';
	$ru['SaveConfig']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ ÐºÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸ÑŽ';
	$ru['SavePass']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
	$ru['SaveFile']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð» ';
	$ru['Save']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ';
	$ru['Leave']='ÐžÑÑ‚Ð°Ð²ÑŒ';
	$ru['Edit']='Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ';
	$ru['View']='ÐŸÑ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€';
	$ru['Config']='ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸';
	$ru['Ren']='ÐŸÐµÑ€ÐµÐ¸Ð¼ÐµÐ½Ð¾Ð²Ð°Ñ‚ÑŒ';
	$ru['Rem']='Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ';
	$ru['Compress']='Ð¡Ð¶Ð°Ñ‚ÑŒ';
	$ru['Decompress']='Ð Ð°ÑÐ¿Ð°ÐºÐ¾Ð²Ð°Ñ‚ÑŒ';
	$ru['ResolveIDs']='ÐžÐ¿Ñ€ÐµÐ´ÐµÐ»ÑÑ‚ÑŒ id';
	$ru['Move']='ÐŸÐµÑ€ÐµÐ¼ÐµÑÑ‚Ð¸Ñ‚ÑŒ';
	$ru['Copy']='ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ';
	$ru['ServerInfo']='Ð˜Ð½Ñ„Ð¾ Ð¾ ÑÐµÑ€Ð²ÐµÑ€Ðµ';
	$ru['CreateDir']='Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ð¿Ð°Ð¿ÐºÑƒ';
	$ru['CreateArq']='Ð¡Ð¾Ð·Ð´Ð°Ð¹Ñ‚Ðµ Ñ„Ð°Ð¹Ð» ';
	$ru['ExecCmd']='Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ';
	$ru['Upload']='Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ';
	$ru['UploadEnd']='Ð—Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½Ð¾';
	$ru['Perm']='ÐŸÑ€Ð°Ð²Ð°';
	$ru['Perms']='Ð Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ñ';
	$ru['Owner']='Ð’Ð»Ð°Ð´ÐµÐ»ÐµÑ†';
	$ru['Group']='Ð“Ñ€ÑƒÐ¿Ð¿Ð°';
	$ru['Other']='Ð”Ñ€ÑƒÐ³Ð¸Ðµ';
	$ru['Size']='Ð Ð°Ð·Ð¼ÐµÑ€';
	$ru['Date']='Ð”Ð°Ñ‚Ð°';
	$ru['Type']='Ð¢Ð¸Ð¿';
	$ru['Free']='Ð¡Ð²Ð¾Ð±Ð¾Ð´Ð½Ð¾';
	$ru['Shell']='Shell';
	$ru['Read']='Ð§Ð¸Ñ‚Ð°Ñ‚ÑŒ';
	$ru['Write']='ÐŸÐ¸ÑÐ°Ñ‚ÑŒ';
	$ru['Exec']='Ð’Ñ‹Ð¿Ð¾Ð»Ð½ÑÑ‚ÑŒ';
	$ru['Apply']='ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ';
	$ru['StickyBit']='StickyBit';
	$ru['Pass']='ÐŸÐ°Ñ€Ð¾Ð»ÑŒ';
	$ru['Lang']='Ð¯Ð·Ñ‹Ðº';
	$ru['File']='Ð¤Ð°Ð¹Ð»';
	$ru['File_s']='Ð¤Ð°Ð¹Ð»..';
	$ru['Dir_s']='ÐŸÐ°Ð¿..';
	$ru['To']='Ð²';
	$ru['Destination']='ÐÐ°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ';
	$ru['Configurations']='ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ';
	$ru['JSError']='ÐžÑˆÐ¸Ð±ÐºÐ° JavaScript';
	$ru['NoSel']='Ð½ÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ñ… ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð²';
	$ru['SelDir']='Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð¿Ð°Ð¿ÐºÑƒ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ Ð½Ð° Ð»ÐµÐ²Ð¾Ð¼ Ð´ÐµÑ€ÐµÐ²Ðµ ';
	$ru['TypeDir']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° ';
	$ru['TypeArq']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ Ñ„Ð°Ð¹Ð»Ð°';
	$ru['TypeCmd']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñƒ ';
	$ru['TypeArqComp']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ Ñ„Ð°Ð¹Ð»Ð° ,Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð¸Ðµ\\n ÑÑ‚Ð¾ Ð¿Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»Ð¸Ñ‚ÑŒ Ñ‚Ð¸Ð¿ ÑÐ¶Ð°Ñ‚Ð¸Ñ \\n ÐŸÑ€Ð¸Ð¼ÐµÑ€:.. \\n nome.zip \\n nome.tar \\n nome.bzip \\n nome.gzip ';
	$ru['RemSel']='Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹';
	$ru['NoDestDir']='Ð½ÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ð³Ð¾ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ';
	$ru['DestEqOrig']='ÐŸÑ€Ð¾Ð¸ÑÑ…Ð¾Ð¶Ð´ÐµÐ½Ð¸Ðµ Ð¸ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð¾Ð² Ñ€Ð°Ð²Ð½Ñ‹ ';
	$ru['InvalidDest']='ÐÐ°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° Ð½ÐµÐ´ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾';
	$ru['NoNewPerm']='ÐÐ¾Ð²Ñ‹Ðµ Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ñ Ð½Ðµ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ñ‹';
	$ru['CopyTo']='ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð² ';
	$ru['MoveTo']='ÐŸÐµÑ€ÐµÐ¼ÐµÑÑ‚Ð¸Ñ‚ÑŒ Ð²';
	$ru['AlterPermTo']='Ð˜Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ð¹ Ð² ';
	$ru['ConfExec']='ÐŸÐ¾Ð´Ñ‚Ð²ÐµÑ€Ð´Ð¸Ñ‚ÑŒ Ð’Ð«ÐŸÐžÐ›ÐÐ˜Ð¢Ð¬ ';
	$ru['ConfRem']='ÐŸÐ¾Ð´Ñ‚Ð²ÐµÑ€Ð´Ð¸Ñ‚ÑŒ Ð£Ð”ÐÐ›Ð•ÐÐ˜Ð•';
	$ru['EmptyDir']='ÐŸÑƒÑÑ‚Ð¾Ð¹ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³ ';
	$ru['IOError']='I/O Error';
	$ru['FileMan']='PHP Ð¤Ð°Ð¹Ð»Ð¾Ð²Ñ‹Ð¹ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€ ';
	$ru['TypePass']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
	$ru['InvPass']='ÐÐµÐ²ÐµÑ€Ð½Ñ‹Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
	$ru['ReadDenied']='Ð”Ð¾ÑÑ‚ÑƒÐ¿ Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½ ';
	$ru['FileNotFound']='Ð¤Ð°Ð¹Ð» Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½';
	$ru['AutoClose']='Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾Ð»Ð½Ð¾ÑÑ‚ÑŒÑŽ ';
	$ru['OutDocRoot']='Ð¤Ð°Ð¹Ð»Ñ‹ Ð·Ð° Ð¿Ñ€ÐµÐ´ÐµÐ»Ð°Ð¼Ð¸ DOCUMENT_ROOT';
	$ru['NoCmd']='ÐžÑˆÐ¸Ð±ÐºÐ°: ÐÐµ Ð¿Ð¾Ð´Ð´ÐµÑ€Ð¶Ð¸Ð²Ð°ÐµÐ¼Ð°Ñ ÐºÐ¾Ð¼Ð°Ð½Ð´Ð°';
	$ru['ConfTrySave']='Ð¤Ð°Ð¹Ð» Ð±ÐµÐ· Ð¿Ñ€Ð°Ð² Ð½Ð° Ð·Ð°Ð¿Ð¸ÑÑŒ. \\n Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð² Ð»ÑŽÐ±Ð¾Ð¼ ÑÐ»ÑƒÑ‡Ð°Ðµ. ';
	$ru['ConfSaved']='ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ð°';
	$ru['PassSaved']='ÐŸÐ°Ñ€Ð¾Ð»ÑŒ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½';
	$ru['FileDirExists']='Ð¤Ð°Ð¹Ð» Ð¸Ð»Ð¸ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³ ÑƒÐ¶Ðµ ÑÑƒÑ‰ÐµÑÑ‚Ð²ÑƒÐµÑ‚';
	$ru['NoPhpinfo']='Ð¤ÑƒÐ½ÐºÑ†Ð¸Ñ PHPInfo Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°';
	$ru['NoReturn']='ÐÐµÑ‚ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‚Ð°';
	$ru['FileSent']='Ð¤Ð°Ð¹Ð» Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½';
	$ru['SpaceLimReached']='Ð”Ð¾ÑÑ‚Ð¸Ð³Ð½ÑƒÑ‚ Ð¿Ñ€ÐµÐ´ÐµÐ» ÐŸÑ€Ð¾ÑÑ‚Ñ€Ð°Ð½ÑÑ‚Ð²Ð°';
	$ru['InvExt']='ÐÐµÐ²ÐµÑ€Ð½Ð¾Ðµ Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð¸Ðµ';
	$ru['FileNoOverw']='Ð¤Ð°Ð¹Ð» Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿Ð¸ÑÐ°Ð½ ';
	$ru['FileOverw']='Ð¤Ð°Ð¹Ð» Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿Ð¸ÑÑ‹Ð²Ð°ÐµÑ‚ÑÑ';
	$ru['FileIgnored']='Ð¤Ð°Ð¹Ð» Ð¸Ð³Ð½Ð¾Ñ€Ð¸Ñ€ÑƒÐµÑ‚ÑÑ';
	$ru['ChkVer']='ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ';
	$ru['ChkVerAvailable']=' Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð° Ð½Ð¾Ð²Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ, Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð·Ð´ÐµÑÑŒ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð½Ð°Ñ‡Ð°Ñ‚ÑŒ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÑƒ! ';
	$ru['ChkVerNotAvailable']='ÐÐµÑ‚ Ð½Ð¾Ð²Ð¾Ð¹ Ð²ÐµÑ€ÑÐ¸Ð¸. :(';
	$ru['ChkVerError']='ÐžÑˆÐ¸Ð±ÐºÐ° Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ñ. ';
	$ru['Website']='Ð¡Ð°Ð¹Ñ‚';
	$ru['SendingForm']='ÐžÑ‚Ð¿Ñ€Ð°Ð²ÐºÐ° Ñ„Ð°Ð¹Ð»Ð¾Ð², Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿Ð¾Ð´Ð¾Ð¶Ð´Ð¸Ñ‚Ðµ ';
	$ru['NoFileSel']='ÐÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ñ… Ñ„Ð°Ð¹Ð»Ð¾Ð²';
	$ru['SelAll']='Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð²ÑÐµ';
	$ru['SelNone']='ÐžÑ‚Ð¼ÐµÐ½Ð°';
	$ru['SelInverse']='ÐžÐ±Ñ€Ð°Ñ‚Ð¸Ñ‚ÑŒ';
	$ru['Selected_s']='Ð’Ñ‹Ð±Ñ€Ð°Ð½';
	$ru['Total']='Ð’ÑÐµÐ³Ð¾';
	$ru['Partition']='Ð Ð°Ð·Ð´ÐµÐ»';
	$ru['RenderTime']='Ð¡ÐºÑ€Ð¸Ð¿Ñ‚ Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½ Ð·Ð°';
	$ru['Seconds']='Ð¡ÐµÐºÑƒÐ½Ð´';
	$ru['ErrorReport']='ÐžÑ‚Ñ‡ÐµÑ‚ Ð¾Ð± Ð¾ÑˆÐ¸Ð±ÐºÐ°Ñ…';
    ...
    $cat['NoDestDir'] = 'No s`ha seleccionat el directori de destÃ­';
    $cat['DestEqOrig'] = 'L`origen i el destÃ­ sÃ³n iguals';
    $cat['InvalidDest'] = 'El destÃ­ del directori Ã©s invÃ lid';
    $cat['NoNewPerm'] = 'Els permisos no s`han pogut establir';
    $cat['CopyTo'] = 'COPIAR a';
    $cat['MoveTo'] = 'MOURE a';
    $cat['AlterPermTo'] = 'CAMBIAR PERMISOS a';
    $cat['ConfExec'] = 'Confirmar EXECUCIÃ“';
    ...
    $cat['InvPass'] = 'Clau invÃ lida';
    $cat['ReadDenied'] = 'AccÃ©s de lectura denegat';
    ...
    $cat['ConfSaved'] = 'ConfiguraciÃ³ Desada';
    $cat['PassSaved'] = 'Clau desada';
    $cat['FileDirExists'] = 'Arxiu o directori ja existent';
    $cat['NoPhpinfo'] = 'FunciÃ³ phpinfo() no habilitada';
    $cat['NoReturn'] = 'sense retorn';
    $cat['FileSent'] = 'Arxiu enviat';
    $cat['SpaceLimReached'] = 'LÃ­mit d`espaci al disc assolit';
    $cat['InvExt'] = 'ExtensiÃ³ no vÃ lida';
    ...
    $cat['ChkVerAvailable'] = 'Nova versiÃ³, feu clic aquÃ­ per descarregar';
    $cat['ChkVerNotAvailable'] = 'La vostra versiÃ³ Ã©s la mÃ©s recent.';
    $cat['ChkVerError'] = 'Error de connexiÃ³.';
        ...
        if ($handle = @opendir($dir_current)){
            ...
            if (count($mat_dir)){
                ...
                if ($dir_before != $dir_current){
                    if (strstr($expanded_dir_list,":$dir_current/$dir_name")) $op_str = "[â€“]";
                    else $op_str = "[+]";
...
function config_form(){
	...
	<select name=newlang>
    	<option value=cat>Catalan - by Pere BorrÃ s AKA @Norl
